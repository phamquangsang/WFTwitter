        ...
        mClient.getHomeTimeline(sinceId, -1, COUNT, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                try {
                    ...
                    if (DatabaseUtilities.insertToDatabase(getActivity(), list, Contract.TweetEntry.TABLE_NAME) == 1)//if insert to database succeed?
                    {
...
//            Toast.makeText(TimelineActivity.this,"no internet connection available...",Toast.LENGTH_LONG).show();
    ...
    protected void loadingTweets() {
        List<Tweet> dataSet = DatabaseUtilities.queryTweets(getContext());
    ...
    public void onAttach(Context context) {
        if(context instanceof TimelineActivity){
            ...
            activity.setOnPostButtonClickListener(new TimelineActivity.OnPostButtonClickListener() {
                @Override
